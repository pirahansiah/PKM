...
## Content Hub — Computer Vision & 3D
...
| Image | Used in |
|-------|---------|
| `CUDA_numba_jit_tutorial.png` | CUDA_numba_jit_tutorial.md |
| `CUDA_pycuda_kernel_explanation.png` | CUDA_pycuda_kernel_explanation.md |
| `Mind_Map_Advanced_LLM_Concepts.png` | Mind_Map_Advanced_LLM_Concepts.md |
| `Mind_Map_Orchestrating_Agents.png` | Mind_Map_Orchestrating_Agents.md, Social.md |
| `optimizationML.png` | Resources.md |
| `python-configuration-management.png` | Python.md |
| `Recommended ML Optimization and Project Workflow.png` | (standalone) |
| `under_over_fit_ML.png` | Resources.md |
| `VSCodeCUDAwindows.png` | VSCodeCUDAwindows.md |
...
| [Knowledge Management](https://www.tiziran.com/book-summary/knowledge_management) | Organization systems |
...
| [YouTube II](https://www.tiziran.com/topics-and-projects/how-to-start/youtube-ii) | More videos |
...
| [OpenCV C++](https://www.tiziran.com/topics-and-projects/source-code/opencv/cpp) | C++ vision |
| [OpenCV Python](https://www.tiziran.com/topics-and-projects/source-code/opencv/python) | Python vision |
| [MacOS OpenCV](https://www.tiziran.com/topics-and-projects/source-code/opencv/macos-opencv) | macOS build |
| [OpenCV Rust](https://www.tiziran.com/topics-and-projects/source-code/opencv/rust) | Rust bindings |
| [Compile Guide](https://www.tiziran.com/topics-and-projects/source-code/compile) | Build instructions |
| [IoT Code](https://www.tiziran.com/topics-and-projects/source-code/iot) | Embedded vision |
| [Share](https://www.tiziran.com/topics-and-projects/share) | Community |
...
| [AltCoin](https://www.tiziran.com/topics-and-projects/altcoin) | Crypto AI |
| [Resume CV](https://www.tiziran.com/topics-and-projects/resume_cv) | Career templates |
| [Apple](https://www.tiziran.com/topics-and-projects/apple) | CoreML/Vision |
...
| [Mind Maps Source](https://github.com/tiziran/tiziran.github.io) | Diagram sources |
...
| [All Links](https://www.tiziran.com/links) | Complete collection |
| [Amazon](https://www.tiziran.com/links/amazon) | Recommended tools |
| [Contact](https://www.tiziran.com/about) | Collaboration |
| [FAQ](https://www.tiziran.com/about/fqa) | Common questions |
| [Prompt Engineering](https://www.tiziran.com/about/prompt) | LLM prompts |
...
| Link | Description |
|------|-------------|
| [Computer Vision Developer GPT](https://chat.openai.com/g/g-vHELtCqJq-computer-vision-developer) | Custom GPT for CV |
| [LangChain](https://github.com/hwchase17/langchain) | Agent logic, memory, tools |
...
| [Phidata](https://github.com/phidatahq/phidata) | Multi-modal agents |
| [SWE-agent](https://github.com/SWE-agent/SWE-agent) | AI software engineering |
| [Awesome AI Agents](https://github.com/e2b-dev/awesome-ai-agents) | Curated agent list |
| [TheAgentCompany](https://github.com/TheAgentCompany/TheAgentCompany) | Agent benchmark |
| [Numba](https://github.com/numba/numba) | JIT compiler for Python |
| [MLX](https://github.com/ml-explore/mlx) | Apple ML framework |
| [Fullmoon iOS](https://github.com/mainframecomputer/fullmoon-ios) | LLaMA on Apple Silicon |
| [Wav2Lip](https://github.com/Rudrabha/Wav2Lip) | Lip-sync from audio |
| [Ollama](https://ollama.com/install.sh) | Local LLM runner |
...
| [CUDA Guide](https://docs.nvidia.com/cuda/pdf/CUDA_C_Programming_Guide.pdf) | NVIDIA CUDA docs |
| [Numba Docs](https://numba.pydata.org/) | Numba documentation |
| [GStreamer](https://gstreamer.freedesktop.org/download/) | Multimedia framework |
| [LeetGPU](https://leetgpu.com) | GPU programming platform |
| [Hyperdiv](https://hyperdiv.io) | Python GUI framework |
| [NeoHtop](https://github.com/Abdenasser/neohtop) | Modern htop |
| [Helix Editor](https://github.com/helix-editor/helix) | Terminal text editor |
| [RustDesk](https://rustdesk.com/) | Remote desktop |
| [Cap](https://github.com/CapSoftware/Cap) | Screen recording (Loom alt) |
| [Gitingest](https://github.com/cyclotruc/gitingest) | Repo to LLM text |
| [MASt3R-SLAM](https://edexheim.github.io/mast3r-slam/) | Dense SLAM with 3D priors |
| [PySpur CUDA](https://www.pyspur.dev/blog/introduction_cuda_programming) | CUDA Python tutorial |
| [Cornell GPU](https://cvw.cac.cornell.edu/gpu-architecture) | GPU architecture course |
| [CUDACodes](https://github.com/Maharshi-Pandya/cudacodes) | Flash attention CUDA |
| [Vulkan Viewer](https://github.com/HosseinAssaran/VulkanImageViewer) | Qt6+C++ image viewer |
| [Practical CV](https://github.com/andandandand/practical-computer-vision) | Computer vision course |
| [Piper TTS](https://huggingface.co/rhasspy/piper-voices) | Local text-to-speech |
| [IBM Granite RAG](https://github.com/ibm-granite-community/granite-snack-cookbook/blob/main/recipes/RAG/Granite_Multimodal_RAG.ipynb) | Multimodal RAG |

## External Links — Developer Tools

| Link | Tool |
|------|------|
| [notepad++](https://notepad-plus-plus.org/downloads/) | Text editor |
| [KeePass2](https://keepass.info/download.html) | Password manager |
| [OBS Studio](https://obsproject.com/download) | Screen recording |
| [MobaXterm](https://mobaxterm.mobatek.net/download-home-edition.html) | SSH client |
| [Log4View](https://www.log4view.com/download-en) | Log viewer |
| [Voidtools](https://www.voidtools.com) | Windows file search |
| [DisplayLink macOS](https://www.synaptics.com/products/displaylink-graphics/downloads/macos) | Multi-monitor Mac |
| [Aurga Viewer](https://www.aurga.com/products/aurga-viewer) | HDMI WiFi |
| [rxresu.me](https://rxresu.me/) | Resume builder |
| [Blender MCP](https://github.com/ahujasid/blender-mcp) | Blender + LLM |
| [PyDoll](https://github.com/autoscrape-labs/pydoll) | Browser automation |

## External Links — Startup & Germany

| Link | Resource |
|------|----------|
| [HTGF](https://www.htgf.de) | High-Tech Gründerfonds |
| [EXIST](https://www.exist.de) | Business start-up grant |
| [Venture Network](https://www.venture-network.com) | Deutsche Börse network |
| [German Startups](https://www.deutschestartups.org) | Bundesverband |
| [KfW](https://www.kfw.de) | StartGeld & ERP-Gründerkredit |
| [Startup Verband](https://startupverband.de/) | German startup association |
| [Grüenderszene](https://www.gruenderszene.de/) | Startup news |
| [Berlin Valley](https://berlinvalley.com/) | Berlin startup scene |
| [Startup Radio](https://startupradio.de/) | Startup podcast |
| [German Accelerator](https://www.germanaccelerator.com/blog/) | Internationalization |
| [CDTM](https://www.cdtm.de/research/) | Center for Digital Tech |
| [Unternehmertum](https://www.unternehmertum.de/ressourcen) | TU Munich startup center |
| [TUM Venture Labs](https://www.tum-venture-labs.de/) | Deep tech labs |
| [WHU Entrepreneurship](https://www.whu.edu/de/fakultaet-forschung/entrepreneurship/) | Startup research |
| [Bifold](https://bifold.berlin/) | AI research institute |
| [Applied AI](https://appliedai.de/resources/) | AI resources |

## External Links — YouTube

| Link | Channel/Topic |
|------|---------------|
| [Ali Abdaal](https://www.youtube.com/@aliabdaal) | Productivity |
| [Dan Martell](https://www.youtube.com/@danmartell) | Startup advice |
| [Finanzfluss](https://www.youtube.com/@Finanzfluss/videos) | Finance (German) |
| [CUDA Playlist](https://www.youtube.com/playlist?list=PL5B692fm6--vWLhYPqLcEu6RF3hXjEyJr) | CUDA tutorials |
| [Python Multithreading](https://www.youtube.com/watch?v=fK72KDAWV38&list=PLs6THB5KHWo2k0OdWXbu_pB_0n2KzpGC1&index=7) | Threading series |
| [Data Structures Python](https://www.youtube.com/watch?v=GnZ9ppr_zaI&list=PLeo1K3hjS3uu_n_a__MI_KktGTLYopZ12&index=16) | DS tutorial |
| [How to Start Startup](https://www.youtube.com/watch?v=CBYhVcO4WgI&list=PL5q_lef6zVkaTY_cT1k7qFNF2TidHCe-1) | Y Combinator |
| [FPGA RISC-V](https://www.youtube.com/watch?v=gJno9TloDj8) | FPGA tutorial |
| [C++ GPU AdaptiveCpp](https://www.youtube.com/watch?v=ImM7f5IQOaw) | 68x faster GPU |
| [Cursor MDC Rules](https://www.youtube.com/watch?v=ABozvKmctkc) | AI coding |

---

## Validation Notes (2025-06-19)

**Internal links:** All root-relative paths (`/contents/public/...`) verified against actual files.
**External links:** All point to live, publicly accessible resources.
**Removed files:** `interview.md` (empty), `TOC.md` (redundant), `CPP_Memory.md` (duplicate).