...
tags:
  ...
  - qwen
hashtags: "#llm #optimization #quantization #speculativedecoding #mlx #qwen #research"
description: "Every method to run big LLMs fast and small — quantization (Unsloth Dynamic 3.0), multi-token prediction, DFlash2, oMLX/MLX, FlashAttention-2 — with visualizations, advanced configs, and a Qwen3.8-Flash synthesis."
---
...
FlashAttention-2: +2× again → up to 73% A100 FLOPs
  ...
  · supports head_dim ≤ 256, MQA/GQA
      ...
      <!-- Slide 9: Synthesis Qwen3.8-Flash -->
      <section>
