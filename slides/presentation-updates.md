...
tags:
  ...
  - features
  - update
hashtags: "#presentation #hermes-agent #features #update"
description: "Comprehensive presentation: Recent Hermes Agent updates plus a complete tour of every feature — setup, bots, multi-agent, research, profiling, cron, messaging, group bots, artifacts, skills, and more."
---
...
<style>
  ...
  .reveal .slides section { height: 100%; display: flex !important; flex-direction: column !important; justify-content: center !important; align-items: center !important; padding: 18px !important; box-sizing: border-box !important; }
...
<script>
  let deck = new Reveal(document.querySelector('.presentation-panel'), {
    ...
    controls: true, progress: true, width: 1050, height: 720,
    margin: 0.08, minScale: 0.2, maxScale: 2.0
  });
  deck.initialize();
  document.getElementById('restart-btn').addEventListener('click', function(e) {
    e.stopPropagation(); deck.slide(0);
  });
