...
### My Patents (3)   
  - [My Patents: A METHOD FOR AUGMENTING A PLURALITY OF FACE IMAGES WO2021060971A1](/notes/pubs/patents/face-augmentation)
  - [My Patents: SYSTEM AND METHOD FOR PROVIDING ADVERTISEMENT CONTENTS BASED ON FACIAL ANALYSIS WO2020141969A2](/notes/pubs/patents/facial-analysis)
  - [My Patents: A METHOD FOR DETECTING A MOVING VEHICLE WO2021107761A1](/notes/pubs/patents/vehicle-detection)    
### My Books (2)
  - [My Book: My_Book_chapter_Camera_Calibration_and_Video_Stabilization_Framework_for_Robot_Localization  in the Book entitled “Control Engineering in Robotics and Industrial Automation" published in Springer](/notes/pubs/books/camera-calibration)
  - [My Book: Computational Intelligence: From Theory to Application explores augmented optical flow methods for video stabilization](/notes/pubs/books/computational-intelligence)     
### My Journals (6)    
  - [My Journal Publications: Adaptive Image Thresholding Based on the Peak Signal-to-noise Ratio (PSNR) ](/notes/pubs/journals/adaptive-thresholding)
  - [My Journal Publications: CHARACTER AND OBJECT RECOGNITION BASED ON GLOBAL FEATURE EXTRACTION](/notes/pubs/journals/character-recognition)
  - [My Journal Publications: GSFT-PSNR Global Single Fuzzy Threshold](/notes/pubs/journals/fuzzy-thresholding)
  - [My Journal Publications: PEAK SIGNAL-TO-NOISE RATIO BASED ON THRESHOLD METHOD FOR IMAGE SEGMENTATION](/notes/pubs/journals/psnr-segmentation)
  - [My Journal Publications: 3D SLAM Simultaneous Localization And Mapping Trends And Humanoid Robot Linkages](/notes/pubs/journals/slam-humanoid)
  - [My Journal Publications: USING AN ANT COLONY OPTIMIZATION ALGORITHM](/notes/pubs/journals/ant-colony)    
### My Conference Papers (10)    
  - [My Conference Papers: 2D versus 3D Map for Environment Movement Objects  ](/notes/pubs/papers/2d-3d-mapping)
  - [My Conference Papers: Adaptive Image Segmentation Based on PSNR for License Plate Recognition ](/notes/pubs/papers/adaptive-segmentation)
  - [My Conference Papers: An evaluation of classification techniques using enhanced Geometrical Topological Feature Analysis ](/notes/pubs/papers/geometrical-topological)
  - [My Conference Papers: Camera Calibration for Multi-Modal Robot Vision ](/notes/pubs/papers/multimodal-calibration)
  - [My Conference Papers: Character Recognition Based on Global Feature ](/notes/pubs/papers/global-feature-recognition)
  - [My Conference Papers: Comparison single thresholding method for handwritten images segmentation ](/notes/pubs/papers/handwritten-thresholding)
  - [My Conference Papers: License Plate Recognition with Multi-Threshold Based on Entropy ](/notes/pubs/papers/license-plate)
  - [My Conference Papers: Multi-threshold Approach for License Plate Recognition System ](/notes/pubs/papers/multi-threshold-plate)
  - [My Conference Papers: Pattern Image Significance for Camera Calibration](/notes/pubs/papers/pattern-calibration)
  - [My Conference Papers: TafreshGrid Grid computing in Tafresh university ](/notes/pubs/papers/grid-computing)
  <!-- - [My Conference Papers: Computer Vision meet LLM ](/notes/pubs/papers/ ) -->
...
{% if page.extname == "CV.md" %}
  ![Dr. Farshid Pirahansiah 3 Patents - AI Innovations in Vehicle Detection, Facial Analysis, and Image Augmentation](/notes/pubs/patents/Dr._Farshid_Pirahansiah_3_Patents_-_AI_Innovations_in_Vehicle_Detection,_Facial_Analysis,_and_Image_Augmentation.png)
{% else %}
  <img src="/notes/pubs/patents/Dr._Farshid_Pirahansiah_3_Patents_-_AI_Innovations_in_Vehicle_Detection,_Facial_Analysis,_and_Image_Augmentation.png" alt="Dr. Farshid Pirahansiah 3 Patents - AI Innovations in Vehicle Detection, Facial Analysis, and Image Augmentation" style="max-width: 100%; height: auto;">
{% endif %}
