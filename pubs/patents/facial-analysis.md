...
{% if page.extname == "facial-analysis-advertisement.md" %}
  ![SYSTEM AND METHOD FOR PROVIDING ADVERTISEMENT CONTENTS BASED ON FACIAL ANALYSIS WO2020141969A2](/notes/pubs/patents/facial-analysis-advertisement.png)
{% else %}
  <img src="/notes/pubs/patents/facial-analysis-advertisement.png" alt="SYSTEM AND METHOD FOR PROVIDING ADVERTISEMENT CONTENTS BASED ON FACIAL ANALYSIS WO2020141969A2" style="max-width: 100%; height: auto;">
{% endif %}
