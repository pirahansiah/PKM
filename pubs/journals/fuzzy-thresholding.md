...
{% if page.extname == "gsft-psnr-fuzzy-threshold.md" %}
  ![Adaptive Image Thresholding Based on the Peak Signal-to-noise Ratio](/notes/pubs/journals/gsft-psnr-fuzzy-threshold.png)
{% else %}
  <img src="/notes/pubs/journals/gsft-psnr-fuzzy-threshold.png" alt="GSFT-PSNR Global Single Fuzzy Threshold" style="max-width: 100%; height: auto;">
{% endif %}
