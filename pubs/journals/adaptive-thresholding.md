...
{% if page.extname == "adaptive-thresholding-psnr.md" %}
  ![Adaptive Image Thresholding Based on the Peak Signal-to-noise Ratio](/notes/pubs/journals/adaptive-thresholding-psnr.png)
{% else %}
  <img src="/notes/pubs/journals/adaptive-thresholding-psnr.png" alt="Adaptive Image Thresholding Based on the Peak Signal-to-noise Ratio" style="max-width: 100%; height: auto;">
{% endif %}
