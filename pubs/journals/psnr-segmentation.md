...
{% else %}
  <img src="/notes/pubs/journals/psnr-threshold-segmentation.png" alt="PEAK SIGNAL-TO-NOISE RATIO BASED ON THRESHOLD METHOD FOR IMAGE SEGMENTATION" style="max-width: 100%; height: auto;">
{% endif %}
