...
{% if page.extname == "character-object-recognition.md" %}
  ![CHARACTER_AND_OBJECT_RECOGNITION_BASED_ON_GLOBAL_FEATURE_EXTRACTION](/notes/pubs/journals/character-object-recognition.png)
{% else %}
  <img src="/notes/pubs/journals/character-object-recognition.png" alt="CHARACTER AND OBJECT RECOGNITION BASED ON GLOBAL FEATURE EXTRACTION" style="max-width: 100%; height: auto;">
{% endif %}
