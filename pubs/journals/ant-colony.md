...
{% if page.extname == "ant-colony-optimization.md" %}
  ![USING AN ANT COLONY OPTIMIZATION ALGORITHM](/notes/pubs/journals/ant-colony-optimization.png)
{% else %}
  <img src="/notes/pubs/journals/ant-colony-optimization.png" alt="USING AN ANT COLONY OPTIMIZATION ALGORITHM" style="max-width: 100%; height: auto;">
{% endif %}
