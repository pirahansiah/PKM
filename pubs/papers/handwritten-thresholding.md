...
{% if page.extname == "comparison-thresholding-handwritten.md" %}
  ![My Conference Paper  Comparison single thresholding method for handwritten images segmentation ](/notes/pubs/papers/comparison-thresholding-handwritten.png)
{% else %}
  <img src="/notes/pubs/papers/comparison-thresholding-handwritten.png" alt="My Conference Paper: Comparison single thresholding method for handwritten images segmentation "  style="max-width: 100%; height: auto;">
{% endif %}
