...
{% if page.extname == "tafreshgrid-grid-computing.md" %}
  ![My Conference Paper  TafreshGrid Grid computing in Tafresh university ](/notes/pubs/papers/tafreshgrid-grid-computing.png)
{% else %}
  <img src="/notes/pubs/papers/tafreshgrid-grid-computing.png" alt="My Conference Paper: TafreshGrid Grid computing in Tafresh university "  style="max-width: 100%; height: auto;">
{% endif %}
