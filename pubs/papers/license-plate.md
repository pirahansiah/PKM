...
{% if page.extname == "license-plate-recognition-entropy.md" %}
  ![My Conference Paper License Plate Recognition with Multi-Threshold Based on Entropy  ](/notes/pubs/papers/license-plate-recognition-entropy.png)
{% else %}
  <img src="/notes/pubs/papers/license-plate-recognition-entropy.png" alt="My Conference Paper: License Plate Recognition with Multi-Threshold Based on Entropy "  style="max-width: 100%; height: auto;">
{% endif %}
