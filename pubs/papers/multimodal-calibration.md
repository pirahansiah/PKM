...
{% else %}
  <img src="/notes/pubs/papers/camera-calibration-multi-modal.png" alt="My Conference Paper: Camera Calibration for Multi-Modal Robot Vision "  style="max-width: 100%; height: auto;">
{% endif %}
