...
{% if page.extname == "classification-geometrical-topological.md" %}
  ![My Conference Paper  An evaluation of classification techniques using enhanced Geometrical Topological Feature Analysis ](/notes/pubs/papers/classification-geometrical-topological.png)
{% else %}
  <img src="/notes/pubs/papers/classification-geometrical-topological.png" alt="My Conference Paper:  An evaluation of classification techniques using enhanced Geometrical Topological Feature Analysis"  style="max-width: 100%; height: auto;">
{% endif %}
