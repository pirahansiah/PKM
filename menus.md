...
- **[Orchestrating Agents](/contents/public/ai-llm/orchestrating-agents/)** — Multi-agent systems, task decomposition, LLM orchestration
- **[Blog: AI & LLMs](/contents/public/ai-llm/blog/)** — RAG vs CAG, multi-agent architectures, AI's impact
- **[Avatar Generator](/contents/public/ai-llm/avatar-generator/)** — Local video avatar with Ollama + Wav2Lip (no cloud)

### CUDA & GPU
- **[Numba JIT](/contents/public/cuda-gpu/numba-jit/)** — Python 10-100x speedup with @jit(nopython=True)
- **[PyCUDA Kernels](/contents/public/cuda-gpu/pycuda-kernels/)** — CUDA C kernels from Python with GPU memory management
