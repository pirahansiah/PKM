...
<style>
  ...
  .search-meta input[type="checkbox"] { accent-color: #22D3EE; }
  ...
  .search-tag:hover, .search-tag.active { background: rgba(34, 211, 238,0.15); border-color: #22D3EE; color: #22D3EE; }
  ...
  .search-result:hover { transform: translateX(4px); border-color: #22D3EE; }
  ...
  .search-result-url { font-size: 0.75rem; color: #22D3EE; margin-bottom: 4px; word-break: break-all; }
  .search-result-body { font-size: 0.82rem; color: var(--text-muted); line-height: 1.4; }
  .search-result-body mark { background: rgba(34, 211, 238,0.25); color: var(--text); border-radius: 2px; padding: 0 2px; }
  ...
  .search-google a { color: #22D3EE; text-decoration: none; font-size: 0.9rem; }
