...
HIGH_PRIORITY_PATH_HINTS = {
    "farshid-vmouse", "vpen-2026", "vpen", "notes", "docs", "readme",
}
...
def build_graph(
    ...
    for note in notes:
        ...
        web_url = "/notes/" + rel_path.rsplit(".", 1)[0] + "/"
        nodes.append({
            "id": note.name,
    ...
    for code in code_notes:
        ...
        nodes.append({
            ...
            "type": "code",
            "url": "/notes/" + rel_path.rsplit(".", 1)[0] + "/" if rel_path.endswith(".md") else "",
...
_HUBS = [
    {"id": "hub-product", "label": "Product", "url": "/notes/docs/product/"},
    {"id": "hub-research", "label": "Research", "url": "/notes/docs/research/"},
    {"id": "hub-solutions", "label": "Solutions", "url": "/notes/docs/solutions/"},
    {"id": "hub-content", "label": "Content Hub", "url": "/notes/docs/"},
    {"id": "hub-wiki", "label": "Wiki", "url": "/notes/wiki/"},
    {"id": "hub-portfolio", "label": "Portfolio", "url": "/notes/pkm/use-cases/"},
]
